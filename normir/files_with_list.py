...
operation_list = ['Тех.операции', 'Промывка', 'Пропарка ФНКТ', 'Поинтервальная опрессовка ФНКТ',
                  'ловильные работы с провыкой', 'ловильные работы без провыки', 'работа печати', 'работа магнита',
                  'расхаживание при прихватах', 'фрезерование', 'райбирование', 'бурение', 'вырезка окон',
                  'наращивание забоя при промывке(с пером)', 'Расхаживание аварийного обрудования,ч', 'ОПЗ',
                  'цементаж', 'закачка глинпорошка', 'кварцевый песок', 'ОЗЦ',
                  'ПЗР в начале и конце смены с заполнением вахтового журнала', 'проведение УТЗ',
                  'Открытие закрытие скв', 'Заправка ПА', 'Мелкие ремонтные работы',
                  'Усредненный поправочный зимний коэффициент',
                  'Очистка от снега в сутки 2 раза', 'Ротор', 'Земляные работы']
