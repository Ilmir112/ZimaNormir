...
operation_list = ['Оттяжки', 'Переезд', 'ПР.перед.ремонтом', 'ЗР.после.ремонта', 'Разрядка', 'Опережающее.глушение',
                  'Глушение', 'Тех.операции', 'первая.категория', 'спо', 'ГИС']
                  # 'наращивание забоя при промывке(с пером)', 'Расхаживание аварийного обрудования,ч', ,
                  # , 'закачка глинпорошка', 'кварцевый песок',
                  # 'ПЗР в начале и конце смены с заполнением вахтового журнала', 'проведение УТЗ',
                  # 'Открытие закрытие скв', 'Мелкие ремонтные работы',
                  # 'Усредненный поправочный зимний коэффициент',
                  # 'Очистка от снега в сутки 2 раза',
                  #  ,
                  # 'Земляные работы']
